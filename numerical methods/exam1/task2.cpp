...
// This piece of code was written by me during the labs so I only modifed the input data
...
int main(){
    ...
    vector<double> a_static = {0, 1, 1, 1, 1, 1};
    vector<double> b_static = {3, 3, 3, 3, 3, 3};
    vector<double> c_static = {2, 2, 2, 2, 2, 0};

    vector<double> a = a_static, b = b_static, c = c_static;

    vector<double> r = {1, 2, 3, 4, 5, 6};
